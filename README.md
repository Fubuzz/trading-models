...
- The feature set now also includes `vol_ratio_5d_20d`, a short-vs-long realized volatility ratio that highlights volatility expansion/contraction regimes; flat windows are treated as a neutral ratio of `1.0`, and the feature does not increase warmup beyond the existing 20-day volatility lookback.
